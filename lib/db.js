...
function initSchema() {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS reviews (
      ...
      verification_type TEXT, -- 'Booking' or 'GPS'
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    ...
    CREATE TABLE IF NOT EXISTS collab_trips (
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS collab_members (
      ...
      FOREIGN KEY (trip_id) REFERENCES collab_trips(id)
    );
    ...
    CREATE TABLE IF NOT EXISTS collab_votes (
      ...
      FOREIGN KEY (suggestion_id) REFERENCES collab_suggestions(id)
    );
    ...
    CREATE TABLE IF NOT EXISTS safety_reviews (
      ...
      police_presence INTEGER CHECK(police_presence BETWEEN 1 AND 5),
      solo_friendly INTEGER CHECK(solo_friendly BETWEEN 1 AND 5),
      comment TEXT,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP
    );

    CREATE TABLE IF NOT EXISTS crowd_checkins (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      place_id TEXT NOT NULL,
